...
abstract class $SentenceCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String documentId, String locale, String text, String hint});
}
...
class _$_Sentence implements _Sentence {
  ...
  @override
  String toString() {
    return 'Sentence(id: $id, documentId: $documentId, locale: $locale, text: $text, hint: $hint)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, documentId, locale, text, hint);
...
abstract class _Sentence implements Sentence {
  factory _Sentence(
      ...
      required final String hint}) = _$_Sentence;
